...
const NavBar = (props) => {
 ...
 let history = useHistory();
  ...
  return (
    <>
      <Navbar className="navbar" bg="black" variant="dark" sticky="top" className="navbar border-bottom border-warning justify-content-between">
          <Navbar.Brand  as={Link} to="/home"><Media>
<img
  width={100}
  height={75}
...
/>
          ...
          <Form inline onSubmit={handleSumbit}>
            ...
            <Button variant="warning" onClick={handleSumbit}>Search</Button>
          </Form>
        <Nav >
          <Nav.Item >
